...
namespace ExtraRolesMod
{
    ...
    public class HarmonyMain : BasePlugin
    {
        ...
        public static CustomToggleOption showSandman = CustomOption.AddToggle("Show Sandman", false);
        ...
        public static CustomNumberOption sandmanSpawnChance =
            CustomOption.AddNumber("Sandman Spawn Chance", 100, 0, 100, 5);
