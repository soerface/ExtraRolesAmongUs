...
namespace ExtraRolesMod
{
    ...
    public class ExtraRoles
    {
        ...
        public static string versionString = "v1.4.3b+sandman";
        ...
        public class ModdedPalette
        {
            ...
            public Color sandmanColor = new Color(113f / 255f, 158f / 255f, 54f / 255f, 1);
        ...
        public class ModdedConfig
        {
            ...
            public bool showSandman { get; set; }
            ...
            public float sandmanSpawnChance { get; set; }
            ...
            public void SetConfigSettings()
            {
                ...
                this.showSandman = HarmonyMain.showSandman.GetValue();
                ...
                this.sandmanSpawnChance = HarmonyMain.sandmanSpawnChance.GetValue();
